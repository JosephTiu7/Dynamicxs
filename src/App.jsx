...
export default function App() {
    // const [isAuthenticated, setIsAuthenticated] = useState(StudentService.isAuthenticated());
            ...
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/Order_checking" element={<Order_checking/>}></Route>
                            ...
                            <Route path="/completed_order" element={<Completed_Order />} />
                            <Route path="/menu" element={<Menu />} />
                            <Route path="/order_history" element={<Order_History />} />
                            <Route path="/homepage" element={<Homepage />} />
                            <Route path="/Order_checking" element={<Order_checking />} />
